...
const Aboutsvg = () => {
  return (
    <>
      ...
      >
        <defs>
          <clipPath id="freepik--clip-path--inject-255">
            <circle
              cx="149.18"
              cy="225.12"
              r="47.37"
              transform="translate(-115.49 171.42) rotate(-45)"
              style={{ fill: "#fff" }}
            />
          </clipPath>
          <clipPath id="freepik--clip-path-2--inject-255">
            <circle
              cx="350.82"
              cy="309.44"
              r="47.37"
        ...
        <g id="freepik--background-complete--inject-255">
          <rect
            y="382.4"
            width={500}
            height="0.25"
          ...
          />
          <path
            d="M165.82,216a7.37,7.37,0,0,1,7.35-7.35h229a7.37,7.37,0,0,1,7.35,7.35v23.66H165.82Z"
            style={{ fill: "#fafafa" }}
          />
          <circle
            cx="225.25"
        ...
        <g id="freepik--Shadow--inject-255">
          <ellipse
            id="freepik--path--inject-255"
            cx={250}
            cy="416.24"
            rx="193.89"
            ry="11.32"
        ...
        <g id="freepik--Page--inject-255">
          ...
          <path
            ...
            style={{ fill: "#fff" }}
          />
          <circle cx="149.18" cy="225.12" r={50} style={{ fill: "#57C84D" }} />
          <circle
            cx="149.18"
            cy="225.12"
            r="47.37"
            ...
            style={{ fill: "#fff" }}
          />
          <g style={{ clipPath: "url(#freepik--clip-path--inject-255)" }}>
            <path
            ...
            />
            <path
              d="M182.45,215.51l-3.19-4.09,5.9-3.29a10.32,10.32,0,0,1,1.71,5.93Z"
              style={{ fill: "#b55b52" }}
            />
            <polygon
              points="178.39 205.76 184.14 204.83 185.16 208.13 179.26 211.42 178.39 205.76"
              style={{ fill: "#b55b52" }}
            />
            <path
            ...
            />
            <path
              d="M151.44,204a19.24,19.24,0,0,0,2.84,4.29,2.9,2.9,0,0,1-2.41.63Z"
              style={{ fill: "#a02724" }}
            />
            <path
            ...
            />
            <path
              d="M127.55,278.34l6.11-.44-3.08,6.74s-5.36.21-6.34-3.88Z"
              style={{ fill: "#b55b52" }}
            />
            <polygon
              points="138.7 281 135.6 286.97 130.58 284.64 133.66 277.9 138.7 281"
              style={{ fill: "#b55b52" }}
            />
          </g>
          <circle cx="350.82" cy="309.44" r={50} style={{ fill: "#57C84D" }} />
          <circle cx="350.82" cy="309.44" r="47.37" style={{ fill: "#fff" }} />
          <g style={{ clipPath: "url(#freepik--clip-path-2--inject-255)" }}>
            <path
            ...
            />
            <polygon
              points="332.87 314.91 330.56 327.35 335.21 330.5 332.87 314.91"
              style={{ opacity: "0.2" }}
            />
            <path
              d="M322.34,315.15l1.52-7.67-6.1,1.77s-.6,5.31,1.86,7.06Z"
              style={{ fill: "#ffb573" }}
            />
            <polygon
              points="323.25 304.11 318.21 306.2 317.76 309.25 323.86 307.48 323.25 304.11"
              style={{ fill: "#ffb573" }}
            />
            <path
            ...
            />
            <path
              d="M345.83,285.06l-1.29-.71S345,285.58,345.83,285.06Z"
              style={{ fill: "#263238" }}
            />
            <path
              d="M347.88,287.65a15.7,15.7,0,0,1-2.85,3.2,2.51,2.51,0,0,0,2,.84Z"
              style={{ fill: "#ed893e" }}
            />
            <path
            ...
            />
            <path
              d="M352.3,286.5l-1.28-.71S351.48,287,352.3,286.5Z"
              style={{ fill: "#263238" }}
            />
            <path
            ...
            />
            <path
              d="M347.87,362l-7.17-3.21,2,7.11s4.56,1,6.54-1.25Z"
              style={{ fill: "#ffb573" }}
            />
            <path
            ...
            />
            <polygon
              points="334.76 360.25 336.79 366.11 342.74 365.88 340.69 358.77 334.76 360.25"
              style={{ fill: "#ffb573" }}
            />
          </g>
          <path
          ...
          />
          <path
            d="M99.83,95a4.17,4.17,0,1,1-4.16-4.17A4.17,4.17,0,0,1,99.83,95Z"
            style={{ fill: "#fff" }}
          />
